...
public class GoogleUser implements UserDetails {
    ...
    public GoogleUser(String id, String email, String userName, String givenName, String familyName,
    ...
    public static GoogleUser fromUserInfoMap(Map<String, Object> map) {
        ...
        return new GoogleUser(
                ...
                map.get("locale") != null ? new Locale((String) map.get("locale")): Locale.ENGLISH,
                (String) map.get("hd"));
    }
